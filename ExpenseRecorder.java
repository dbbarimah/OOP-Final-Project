...
public class ExpenseRecorder implements Expense {
    ...
    public void saveWeeklyReport(String userID) {
        try {
            ...
            BufferedWriter writer = new BufferedWriter(
                    new FileWriter(reportsFolder + "/" + userID + "_week" + this.weekNumber + ".txt"));

            writer.write("Week: " + this.weekNumber + "Report\n");
